        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskType = table.Column<string>(type: "character varying(21)", maxLength: 21, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstructorFeedback = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_homework_submissions_tasks_HomeworkId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_locked_tasks", x => x.TaskId);
                    table.ForeignKey(
                        name: "FK_locked_tasks_tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_quiz_attempts_tasks_QuizId",
                        column: x => x.QuizId,
                        principalTable: "tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeworkSubmissions_Homework_Student_SubmittedAt",
                table: "homework_submissions",
                columns: new[] { "HomeworkId", "StudentId", "SubmittedAt" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttempts_Quiz_Student_AttemptedAt",
                table: "quiz_attempts",
                columns: new[] { "QuizId", "StudentId", "AttemptedAt" },
                descending: new bool[0]);
        }
